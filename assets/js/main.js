  ...
  for (let i = 0; i < 10; i++) {
    ...
    for (let j = 0; j < 10; j++) {
      ...
      cell.addEventListener("click", function () {
        /* 
        ho provato a usare toggle al posto di click per far tornare normale la casella in caso di doppio click ma non funziona all'intero del codice questo è come l'ho scritto :
        ...
        */
        ...
        console.log("Hai cliccato nella casella con il Numero " + this.textContent);
